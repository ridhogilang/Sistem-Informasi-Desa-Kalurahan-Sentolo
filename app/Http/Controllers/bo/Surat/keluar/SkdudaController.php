...
class SkdudaController extends Controller
{
    ...
    {
        $skduda = Skduda::with('tandatangan')
        ...
        return view('bo.page.surat.keluar.surat-kduda', [
    ...
    public function store(Request $request)
    {
        ...
        $record['jenis_surat'] = 'Surat Keterangan Duda / Janda';
        $record['status_surat'] = '1';
        $record['id'] = 'SK-DJ-'. date('YmdHis') . '-' . rand(100, 999);
    ...
    public function contoh() {
        // Menggunakan view untuk mengambil HTML dari template surat-ktm
        $data = view('bo.template.contoh-surat-kduda')->render();
        // Membuat instance DomPDF
        $pdf = Pdf::loadHTML($data);
        // Menghasilkan file PDF dan mengirimkannya sebagai respons stream
        return $pdf->stream();
