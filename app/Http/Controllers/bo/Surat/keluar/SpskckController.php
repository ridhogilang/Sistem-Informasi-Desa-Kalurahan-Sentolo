...
class SpskckController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bo.page.surat.keluar.surat-pskck', [
    ...
    public function store(Request $request)
    {
        ...
        $record['jenis_surat'] = 'Surat Pengantar SKCK';
        $record['status_surat'] = '1';
        $record['id'] = 'SP-SKCK-'. date('YmdHis') . '-' . rand(100, 999);
    ...
    public function contoh() {
        // Menggunakan view untuk mengambil HTML dari template surat-ktm
        $data = view('bo.template.contoh-surat-pskck')->render();
        // Membuat instance DomPDF
        $pdf = Pdf::loadHTML($data);
        // Menghasilkan file PDF dan mengirimkannya sebagai respons stream
        return $pdf->stream();
