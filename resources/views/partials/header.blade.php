        ...
        <div class="header-top-inner">
            <div class="header-top-left">
                <div class="header-top-contact">
                    ...
                    <div class="contact-item">
                        <span class="icon icon-sm pr-1 text-secondary fa-regular fa-envelope"
            ...
            <div class="header-top-right">
                ...
                <a href="https://twitter.com/" target="_blank" rel="noopener" class="header-top-right-link py-0">
        ...
        @foreach ($headers as $index => $header)
            <li class="relative" id="nav-1">
                <a href="{{ $header->link }}"
                    ...
                    data-bs-target="#collapsemenu{{ $index + 1 }}" aria-expanded="true"
                ...
                @if ($header->subheader->count() > 0)
                    <ul class="relative accordion-collapse collapse" id="collapsemenu{{ $index + 1 }}"
                        aria-labelledby="nav1" data-bs-parent="#sidenav">
                        @foreach ($header->subheader as $subHeader)
                            <li class="relative">
                                <a href="{{ $subHeader->link }}"
                                    ...
                                    data-mdb-ripple="true" data-mdb-ripple-color="dark"><i
                                        class="fa-solid fa-circle mr-1"></i>{{ $subHeader->subheader }}</a>
                            </li>
                        @endforeach
                    </ul>
                @endif
