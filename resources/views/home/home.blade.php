    ...
    <script>
        ...
        tabLinks.forEach(function(link) {
            link.addEventListener('click', function(e) {
                ...
                setActiveTab(tabId); // Atur kelas active pada tab yang diklik
                showTabContent(tabId); // Tampilkan konten tab yang sesuai
            });
        });

        // Tampilkan tab konten pertama saat halaman dimuat
        showTabContent('hari-ini');
    </script>
