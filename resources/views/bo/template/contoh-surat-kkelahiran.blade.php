<!DOCTYPE html>
<head>
    <title>SURAT KETERANGAN KELAHIRAN | 3401032201000001</title>
    <style>
        table tr td {
            font-size: 13px;
        }
    ...
    <center>
        ...
        <table class="nosurat">
            <tr>
                <td width="537">
                    <center>
                        <font size="3">Nomor : 000/KET/PEM/IX/2023</font><br>
                    </center>
                </td>
            </tr>
        </table>
        ...
        <table  class="lima">
            ...
            <tr>
                ...
                <td>:</td>
                <td>Siwalan, Sentolo, Sentolo, Kulon Progo, DI Yogyakarta</td>
            </tr>
            <tr>
        ...
        <table class="empat">
            <tr>
                <td>
                    <p>
                        Pihak-pihak yang diterangkan diatas benar-benar adalah penduduk Dusun Siwalan, Kalurahan Sentolo, Kapanewon Sentolo, Kabupaten Kulon Progo yang
                        belum memiliki Akta Kelahiran. Demikian Surat Keterangan ini dibuat dengan benar dan diberikan kepada yang bersangkutan untuk proses lebih lanjut.
                    </p>
                </td>
            </tr>
        </table>
