                                ...
                                <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="row" action="/admin/sistem-informasi/menu" method="POST"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" value="{{ env('APP_URL') }}" name="link"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($menu as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->menu }}</td>
                                                <td>{{ $value->link }}</td>
                                                <td><img src="{{ Storage::url($value->gambar) }}" width="50" height="50">
                                                </td>
                                                <td>{{ $value->urutan }}</td>
                                                @canany(['edit menu', 'hapus menu'])
                                                    <td class="text-center">
                                                        ...
                                                        @can('hapus menu')
                                                            ...
                                                            <a class="btn btn-danger" type="submit" id="deletemenu"
                                                                data-id="{{ $value->id }}"
                                                                href="/admin/sistem-informasi/deletemenu/{{ $value->id }}"><i
                                            ...
                                            @can('edit menu')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-menu-{{ $value->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/menu/{{ $value->id }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label for="gambar" class="col-sm-3 col-form-label">File
                                                                            Upload</label>
                                                                        <div class="col-sm-9">
                                                                            <img src="{{ Storage::url($value->gambar) }}"
                                                                                width="50" height="50">
                                                                            <input class="form-control" name="gambar"
                                                                                type="file" id="gambar" accept=".png">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" name="urutan"
                                                                                class="form-control" id="urutan"
                                                                                value="{{ $value->urutan }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
