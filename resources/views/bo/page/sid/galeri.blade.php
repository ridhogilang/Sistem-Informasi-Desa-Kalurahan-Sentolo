                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @can('hapus galeri')
                                                            <a class="btn btn-danger" type="submit" id="deletegaleri"
                                                                data-id="{{ $item->id }}"
                                                                href="/admin/sistem-informasi/hapus-galeri/{{ $item->id }}"><i
                                            ...
                                            @can('edit galeri')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-Galeri-{{ $item->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/edit-galeri/{{ $item->id }}"
...
@push('footer')
    ...
    <script>
        $('#summernote').summernote({
            ...
            fontNames: ['Poppins', 'Arial', 'Times New Roman',
            'Verdana'], // Tambahkan "Poppins" sebagai pilihan font.
