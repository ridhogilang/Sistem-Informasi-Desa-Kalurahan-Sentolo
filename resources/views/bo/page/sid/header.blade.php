                                            ...
                                            <div class="modal-body">
                                                <form class="row" action="/admin/sistem-informasi/subheader" method="POST">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="urutan" class="col-sm-3 col-form-label">Urutan</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" value="" name="urutan"
                                                                class="form-control" id="urutan" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @can('hapus header')
                                                            ...
                                                            <a class="btn btn-danger" type="submit" id="deleteheader"
                                                                data-id="{{ $value->id }}"
                                                                href="/admin/sistem-informasi/deleteheader/{{ $value->id }}"><i
                                            ...
                                            @can('edit header')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-header-{{ $value->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/header/{{ $value->id }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('put')
                                                                <div class="modal-header">
                                            ...
                                            @can('edit subheader')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-subheader-{{ $value->id }}"
                                                    ...
                                                    <div
                                                        class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/subheader/{{ $value->id }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('put')
                                                                <div class="modal-header">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ $value->subheader }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mb-3">
                                                                        <label for="link"
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.hasSubheaders) {
                                        ...
                                        window.location =
                                            "/admin/sistem-informasi/deleteheader/" +
                                            data_id;
                                        Swal.fire(
                                            'Deleted!',
                                            'Data sudah terhapus.',
