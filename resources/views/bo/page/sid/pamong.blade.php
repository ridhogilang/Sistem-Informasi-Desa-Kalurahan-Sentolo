                                ...
                                <tbody>
                                    ...
                                    @foreach ($pamong as $item)
                                        <tr>
                                            ...
                                            <td>{!! $item->nama !!}</td>
                                            <td>{!! $item->jabatan !!}</td>
                                            <td><img src="{{ Storage::url($item->foto_resmi) }}" width="45"
                                                    height="40">
                                            </td>
                                            @canany(['edit pamong'])
                                            ...
                                            <div class="modal fade" id="Modal-Edit-Pamong-{{ $item->id }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="modal-content">
                                                        <form action="/admin/sistem-informasi/edit-pamong/{{ $item->id }}"
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input class="form-control" name="nama"
                                                                            id="nama" value="{{ $item->nama }}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="artikel"
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <img src="{{ Storage::url($item->foto_resmi) }}"
                                                                            ...
                                                                            height="50">
                                                                        <input class="form-control" name="foto_resmi"
                                                                            type="file" id="foto_resmi"
                                                                            accept=".png, .jpg, .jpeg">
