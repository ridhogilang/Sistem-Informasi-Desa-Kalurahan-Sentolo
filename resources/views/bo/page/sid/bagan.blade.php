                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @can('hapus agenda')
                                                            <a class="btn btn-danger" type="submit" id="deleteAgenda"
                                                                data-id="{{ $item->id }}"
                                                                href="/admin/sistem-informasi/hapus-agenda/{{ $item->id }}"><i
                                            ...
                                            @can('edit agenda')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-Agenda-{{ $item->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/edit-agenda/{{ $item->id }}"
                                            ...
                                            @can('edit jadwal')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-Jadwal-{{ $item->id }}"
                                                    ...
                                                    <div
                                                        class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <form action="/admin/sistem-informasi/edit-jadwal/{{ $item->id }}"
                                                                method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('put')
                                                                <div class="modal-header">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sinergi as $item)
                                            <tr>
                                                ...
                                                <td>{!! $item->nama !!}</td>
                                                <td>{!! $item->link !!}</td>
                                                <td><img src="{{ Storage::url($item->gambar) }}" width="45"
                                                        height="40">
                                                </td>
                                                @canany(['edit sinergi', 'hapus sinergi'])
                                                    <td class="text-center">
                                            ...
                                            @can('edit sinergi')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-Sinergi-{{ $item->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form
                                                                action="/admin/sistem-informasi/edit-sinergi/{{ $item->id }}"
                                                                method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('put')
                                                                <div class="modal-header">
                                            ...
                                            @can('edit statistik')
                                                ...
                                                <div class="modal fade" id="Modal-Edit-Statistik-{{ $item->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <form
                                                                action="/admin/sistem-informasi/edit-statistik/{{ $item->id }}"
                                                                method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('put')
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row mb-3">
                                                                        <label for="artikel" class="col-sm-3 col-form-label">Laki
                                                                            ...
                                                                            Laki</label>
                                                                        <div class="col-sm-9">
                                                                            <input class="form-control" name="lk"
                                                                                id="lk" value="{{ $item->lk }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mb-3">
