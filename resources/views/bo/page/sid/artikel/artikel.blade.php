                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="row g-3" action="/admin/sistem-informasi/artikel" method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    <label for="link" class="form-label" style="margin-right: 10px;">Link
                                                        Google Drive</label><input class="form-check-input" type="checkbox"
                                                        id="checkbox1">
                                                    <input type="text" name="link" class="form-control" id="link"
                                                        style="display: none" value="{{ old('link') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="kategori_link" class="form-label" id="kategori_link"
                                                        style="display: none">Kategori Link Google Drive</label>
                                                    <select id="kategorilink" name="kategori_link" class="form-select"
                                                        style="display: none">
                                                        <option disabled selected value="">Pilih Jenis Link Google Drive
                                                        </option>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="artikel" class="form-label"
                                                        style="margin-right: 10px;">Artikel</label>
                                                    ...
                                                    <td class="text-center">
                                                        @can('edit artikel')
                                                            <a class="btn btn-warning"
                                                                href="/admin/sistem-informasi/showartikel/{{ $value->id }}"><i
