                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Masukkan Email dan password anda untuk login kedalam aplikasi</p>
                                    </div>

                                    <form class="row g-3" action="{{ route('login.perform')}}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-12 text-end">
                                            <p class="small mb-0"><a href=" {{ route('forget_password.index') }}">Lupa Password?</a></p>
                                        </div>
                                    </form>
