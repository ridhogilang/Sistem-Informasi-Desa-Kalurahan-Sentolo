                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="penghasilan" name="penghasilan" class="form-select" required>
                                                    ...
                                                    <option value="< Rp. 500.000" @if(old('penghasilan')=='< Rp. 500.000' ) selected @endif>
                                                        < Rp. 500.000</option>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center d-flex justify-content-evenly">
                                    @can('lihat surat')
                                    <a class="btn {{ ($value->status_surat == '2')?'btn-success':'btn-secondary' }}" type="submit" target="blank" href="/admin/e-surat/surat-ket-hasil/{{$value->id}}/view"><i class="fa-solid fa-print"></i></a>
                                    @endcan
                                    @can('edit surat')
                                    <!-- Button trigger modal -->
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="penghasilan3" name="penghasilan" class="form-select" required>
                                                            ...
                                                            <option value="< Rp. 500.000" {{ ($value->penghasilan == "< Rp. 500.000") ? 'selected' : '' }}>
                                                                < Rp. 500.000</option>
