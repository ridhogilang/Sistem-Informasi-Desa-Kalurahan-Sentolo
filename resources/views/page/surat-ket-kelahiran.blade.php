            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-success btn-sm" type="submit" target="blank" href="/contoh-surat-kkelahiran/view"><i class="fa-solid fa-print" style="margin-right: 5px"></i>Contoh Surat</a>
                                ...
                                @foreach ($skl as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-success" type="submit" target="blank" href="/surat-kkelahiran/{{$value->id}}/view"><i class="fa-solid fa-print"></i></a>
                                            <!-- Button trigger modal -->
                                            <a class="btn btn-warning" type="submit" data-bs-toggle="modal" data-bs-target="#Modal-Edit-SKL{{$value->id}}" href="/edit-surat-kkelahiran/{{$value->id}}"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="Modal-Edit-SKL{{$value->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Modal-Edit-SKL-Label" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <form action="/surat-kkelahiran/{{$value->id}}" method="POST">
                                                    @csrf
                                                    @method('put')
                                                    <div class="modal-header">
