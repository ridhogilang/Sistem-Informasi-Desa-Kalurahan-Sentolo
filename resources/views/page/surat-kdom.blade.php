            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-success btn-sm" type="submit" target="blank" href="/contoh-surat-kdomisili/view"><i class="fa-solid fa-print" style="margin-right: 5px"></i>Contoh Surat</a>
                                ...
                                @foreach ($skd as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-success" type="submit" target="blank" href="surat-kdomisili/{{$value->id}}/view"><i class="fa-solid fa-print"></i></a>
                                            <!-- Button trigger modal -->
                                            <a class="btn btn-warning" type="submit" data-bs-toggle="modal" data-bs-target="#Modal-Edit-SKDOM{{$value->id}}" href="/edit-surat-kdomisili/{{$value->id}}"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="Modal-Edit-SKDOM{{$value->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="Modal-Edit-SKDOM-Label" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <form action="/surat-kdomisili/{{$value->id}}" method="POST">
                                                    @csrf
                                                    @method('put')
                                                    <div class="modal-header">
